...
`./pacbam bam=example/NGSData.bam bed=example/TargetRegions.bed vcf=example/SNPsInTargetRegions.vcf fasta=/path-to-reference-genome/human_g1k_v37.fasta mode=1 out=./example`
